...
<body class="hold-transition login-page">
  ...
  <div class="login-box">
    ...
    <div class="login-logo">
      <a href="#"><b>Candidate</b> Sign Up</a>
    </div><!-- /.login-logo -->
    <div class="login-box-body">
      ...
      <form action="" method="post">
        <div class="form-group has-feedback">
          <input type="text" class="form-control" name='ktp' placeholder="NIK ktp" required>
        ...
        <div class="row">
          <div class="col-xs-12">
            <button name='submit' type="submit" class="btn btn-primary btn-block btn-flat"><i class="fa fa-paper-plane" aria-hidden="true"></i> Register</button>
          </div><!-- /.col -->
        </div>
      </form>
