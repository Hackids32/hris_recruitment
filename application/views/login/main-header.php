...
<a href="index.php" class="logo">
  ...
  <span class="logo-mini"><b>NTC</b></span>
  <!-- logo for regular state and mobile devices -->
  <span class="logo-lg"><b>e-Recruitment</b></span>
</a>
    ...
    <ul class="nav navbar-nav">
      <li class="dropdown messages-menu">
        ...
        <ul class="dropdown-menu">
          ...
          <li>
            <ul class="menu">
              ...
              foreach ($pesan->result_array() as $row) {
                ...
                echo "<li>
                                  <a href='" . base_url() . "login/detail_pesanmasuk/$row[id_hubungi]'>
                                    <div class='pull-left'>
          ...
          <li class="footer"><a href="<?php echo base_url() ?>/login/pesanmasuk">See All Messages</a></li>
        </ul>
      </li>
      <li>
