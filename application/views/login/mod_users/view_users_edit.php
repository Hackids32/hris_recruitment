...
echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
                  <h3 class='box-title'>Edit Data Candidate</h3>
                </div>
              <div class='box-body'>";
$attributes = array('class' => 'form-horizontal', 'role' => 'form');
echo form_open_multipart('login/edit_manajemenuser', $attributes);
echo "<div class='col-md-12'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>No. KTP</th>                 <td><input type='text' class='form-control' name='ktp' value='$rows[ktp]' readonly></td></tr>
                    ...
                    <tr><th scope='row'>Alamat Lengkap</th>                    <td><input type='text' class='form-control' name='alamat' value='$rows[alamat]'></td></tr>
