            <a style='color:#000' href='<?php echo base_url(); ?>login/berita'>
            ...
            <a style='color:#000' href='<?php echo base_url(); ?>login/halamanbaru'>
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
            ...
            <a style='color:#000' href='<?php echo base_url(); ?>login/agenda'>
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
            ...
            <a style='color:#000' href='<?php echo base_url(); ?>login/manajemenuser'>
              <div class="col-md-3 col-sm-6 col-xs-12">
                <div class="info-box">
